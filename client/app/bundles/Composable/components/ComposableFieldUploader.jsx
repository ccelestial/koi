...
class ComposableFieldUploader extends React.Component {
  render() {
    ...
    return(
      <div className="composable--uploader">
        <input type="hidden" />
        <input type="file" data-file-uploader />
      </div>
    );
  }
}

ComposableFieldUploader.propTypes = {
...
export default ComposableFieldUploader;
